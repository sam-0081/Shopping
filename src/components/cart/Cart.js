        ...
        <Container>
            <div className={'flex gap-4 '}>
                <div className={'flex-grow'}>
                    ...
                    <div className="flex-col justify-between items-center border border-gray-200  rounded-2xl gap-4">
                ...
                <div className={'flex-col '}>
                    <div
                        className={`flex-col justify-between items-center border border-gray-200  rounded-2xl gap-4 p-4 my-2`}>
